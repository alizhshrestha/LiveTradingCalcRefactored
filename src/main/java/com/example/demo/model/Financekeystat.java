...
/**
 * The persistent class for the financekeystats database table.
 * 
 */
@Entity
@Table(name="financekeystats")
@Data
@NoArgsConstructor
@AllArgsConstructor
@NamedQuery(name="Financekeystat.findAll", query="SELECT f FROM Financekeystat f")
public class Financekeystat implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	private int idfinKeyStats;
