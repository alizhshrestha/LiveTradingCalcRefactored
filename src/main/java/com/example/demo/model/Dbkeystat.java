...
/**
 * The persistent class for the dbkeystats database table.
 * 
 */
@Entity
@Table(name="dbkeystats")
@Data
@NoArgsConstructor
@AllArgsConstructor
@NamedQuery(name="Dbkeystat.findAll", query="SELECT d FROM Dbkeystat d")
public class Dbkeystat implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	private int iddbKeyStats;
