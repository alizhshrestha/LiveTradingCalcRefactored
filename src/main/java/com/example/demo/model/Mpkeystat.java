...
/**
 * The persistent class for the mpkeystats database table.
 * 
 */
@Entity
@Table(name="mpkeystats")
@Data
@NoArgsConstructor
@AllArgsConstructor
@NamedQuery(name="Mpkeystat.findAll", query="SELECT m FROM Mpkeystat m")
public class Mpkeystat implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	private int idmpkeystats;
